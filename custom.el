...
(setq soulwalker-display-mode 'childframe)           ; completion display in `childframe` or `posframe`
(setq soulwalker-lsp-client 'lsp-bridge)           ; completion client in `lsp-mode` or `lsp-bridge`
...
(setq soulwalker-static-check-backend 'flymake)    ; static check backend in `flycheck` or `flymake`
...
(custom-set-variables
 ...
 '(connection-local-criteria-alist
   '(((:application tramp :machine "localhost")
     ...
     ((:application tramp :machine "192.168.0.100")
      tramp-connection-local-darwin-ps-profile)
     ((:application tramp)
 ...
 '(package-selected-packages '(ansi shut-up epl git commander)))
(custom-set-faces
